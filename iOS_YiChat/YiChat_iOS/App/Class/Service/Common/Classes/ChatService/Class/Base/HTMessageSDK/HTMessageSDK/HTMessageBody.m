...
@interface HTMessageBody ()<NSCoding,NSMutableCopying>

@end

@implementation HTMessageBody

- (id)mutableCopyWithZone:(NSZone *)zone{
    HTMessageBody *model = [[HTMessageBody allocWithZone:zone] init];
