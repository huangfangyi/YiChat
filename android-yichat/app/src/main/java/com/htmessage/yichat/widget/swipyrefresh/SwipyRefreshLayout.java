package com.htmessage.yichat.widget.swipyrefresh;
...
/**
 * The SwipeRefreshLayout should be used whenever the user can refreshALL the
 * contents of a view via a vertical swipe gesture. The activity that
 * instantiates this view should add an OnRefreshListener to be notified
 * whenever the swipe to refreshALL gesture is completed. The SwipeRefreshLayout
 * will notify the listener each and every time the gesture is completed again;
 * the listener is responsible for correctly determining when to actually
 * initiate a refreshALL of its content. If the listener determines there should
 * not be a refreshALL, it must call setRefreshing(false) to cancel any visual
 * indication of a refreshALL. If an activity wishes to show just the progress
 ...
 * refreshALL of the content wherever this gesture is used.
 * </p>
 */
...
public class SwipyRefreshLayout extends ViewGroup {
    ...
    /**
     * The refreshALL indicator starting and resting position is always positioned
    ...
    /**
     * The refreshALL indicator resting position is always positioned near the top
    ...
    /**
     * Set the listener to be notified when a refreshALL is triggered via the swipe
     * gesture.
     */
    ...
    /**
     * Notify the widget that refreshALL state has changed. Do not call this when
     * refreshALL is triggered by a swipe gesture.
     *
     * @param refreshing Whether or not the view should show refreshALL progress.
     */
    ...
    /**
     * @return Whether the SwipeRefreshWidget is actively showing refreshALL
     * progress.
     */
...
//    }
     ...
     * triggers a refreshALL should implement this interface.
     */
