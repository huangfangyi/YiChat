...
public interface PasswordBasePrester  extends BasePresenter {
    ...
    void resetPassword(String cacheCode, String smsCode, String password, String confimPwd, String mobile,boolean isReset);

    void bindMobile(String cacheCode, String smsCode, String password, String confimPwd, String mobile,boolean isBind);
