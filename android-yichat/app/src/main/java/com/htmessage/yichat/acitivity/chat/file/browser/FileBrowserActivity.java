...
import com.htmessage.yichat.acitivity.chat.file.adapter.TViewHolder;
...
public class FileBrowserActivity extends BaseActivity implements TAdapterDelegate {
    ...
    private void initData() {
        if (!CommonUtils.checkPermission(this, Manifest.permission.READ_EXTERNAL_STORAGE) || CommonUtils.checkPermission(this, Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
        ...
        fileListView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (file.exists() && file.canRead()) {
                    ...
                    //没有权限
                    CommonUtils.showToastShort(FileBrowserActivity.this, R.string.no_pression);
                }
            }
        });
    }
