...
import static com.htmessage.update.uitls.AppInfoUtil.getLauncherClassName;


/**
 * Created by huangfangyi on 2019/7/7.
 * qq 84543217
 */
...
public class BadgeUtil {
  ...
  /*  <uses-permission android:name="com.android.launcher.permission.INSTALL_SHORTCUT"/>
    ...
    public static void setBadgeCount(Context context, int count,int icon,Notification notification) {
        ...
        if (Build.MANUFACTURER.equalsIgnoreCase("xiaomi")) {
            setBadgeOfMIUI(context, count,icon,notification);
    ...
    private static void setBadgeOfMIUI(Context context, int count, int icon,Notification notification) {
...
//        Notification notification = builder.build();
        try {
            ...
            Log.d("xiaomi---e",e.getMessage());
            e.printStackTrace();
        }
//        mNotificationManager.notify(0, notification);
//        sendToXiaoMi(context,88);
    }
    ...
    public static void resetBadgeCount(Context context,int icon) {
        ...
        setBadgeCount(context, 0,icon,null);
    }
