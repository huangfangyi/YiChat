package com.fanxin.app.main.widget;
 ...
 */
public class MomentsView extends ViewGroup implements OnDetectScrollListener{
   ...
   private  OnMoreDataListener onMoreDataListener;
    ...
    private void initRainbowView() {
        ...
        mRainbowView.setImageResource(R.drawable.fx_icon_circle);
    ...
    private void initListView() {
        ...
        View mHeadViw = LayoutInflater.from(getContext()).inflate(R.layout.fx_item_moments_header, null);
    ...
    public android.view.ViewGroup.LayoutParams generateLayoutParams(
            AttributeSet attrs) {
        return new MomentsView.LayoutParams(getContext(), attrs);
    }
    ...
    protected boolean checkLayoutParams(android.view.ViewGroup.LayoutParams p) {
        return p instanceof MomentsView.LayoutParams;
    }
