...
import com.yinglouquan.app.comments.AddPopWindow.ClickCallBack;
import com.yinglouquan.app.comments.SocialApiTask.DataCallBack;
import com.yinglouquan.app.domain.User;
import com.yinglouquan.app.fx.UserDetailActivity;
    ...
    public View getView(final int position, View convertView,
        ...
        if (!imageStr.equals("0")) {
            ...
            holder.image_1.setImageURI(
                    Uri.parse(Constant.URL_SOCIAL_PHOTO + images[0]));
            ...
            if (imNumb == 4) {
                ...
                holder.image_2.setImageURI(
                        Uri.parse(Constant.URL_SOCIAL_PHOTO + images[1]));
                ...
                holder.image_4.setImageURI(
                        Uri.parse(Constant.URL_SOCIAL_PHOTO + images[2]));
                ...
                holder.image_5.setImageURI(
                        Uri.parse(Constant.URL_SOCIAL_PHOTO + images[3]));
                            ...
                            if (imNumb > 4) {
                                ...
                                if (imNumb > 5) {
                                    ...
                                    holder.image_6.setImageURI(
                                            Uri.parse(Constant.URL_SOCIAL_PHOTO
                                                    + images[5]));
        ...
        holder.tv_time.setText(
                getTime(rel_time, MYApplication.getInstance().getTime()));
